...
<html>
	<head>
		...
		<script>
			function remover(id) {
				location.href = 'tarefa_controller.php?acao=remover&2&id='+id;
			}

			function editar(id, txt) {
				let form = document.createElement('form');
				form.method = 'post';
				form.action = 'tarefa_controller.php?acao=edita&2';
				form.className = 'row';
			...
			function marcarRealizado(id) {
				location.href = 'tarefa_controller.php?acao=marcar&2&id='+id;
			}
		</script>
	</head>
