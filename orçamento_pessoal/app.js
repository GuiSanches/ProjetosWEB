...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('CaixaTipo').className = 'modal-header text-success'
        ...
        document.getElementById('CaixaTipo').className = 'modal-header text-danger'
        document.getElementById("modal_titulo").innerHTML = "Existem campos obrigatórios que não foram inseridos";
